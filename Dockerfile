...
ENV PYTHONPATH=/opt/spark/python/lib/pyspark.zip:/opt/spark/python/lib/py4j-*.zip:/opt/spark/work-dir/merlin/:/opt/spark/work-dir/

ADD main.py /opt/spark/work-dir/
ADD entry.py /opt/spark/work-dir/
ADD merlin /opt/spark/work-dir/merlin
ADD requirements.txt /opt/spark/work-dir/requirements.txt
